...
export async function getAlbumData(albumId: number) {
  const response = await fetch(
    `${process.env.STRAPI_URL}/api/capl-albums/${albumId}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${process.env.STRAPI_BEARER_TOKEN}`,
...
export async function getArtistData(artistId: number) {
  const response = await fetch(
    `${process.env.STRAPI_URL}/api/capl-artists/${artistId}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${process.env.STRAPI_BEARER_TOKEN}`,
...
export async function getMusicData(musicId: number) {
  const response = await fetch(
    `${process.env.STRAPI_URL}/api/capl-musics/${musicId}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${process.env.STRAPI_BEARER_TOKEN}`,
...
export async function getPlaylistData(playlistId: number) {
  const response = await fetch(
    `${process.env.STRAPI_URL}/api/capl-playlists/${playlistId}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${process.env.STRAPI_BEARER_TOKEN}`,
